	...
	<div class="card">
		<h5 class="card-header">Appeal details</h5>
  		<div class="card-body">
                    ...
                    <div class="col-12">
          			...
          			<div class="col-5">
        	    		...
        	    		<p class="card-text">
                            ...
                            <br /><a href="https://en.wikipedia.org/w/index.php?title=Special:Log/block&page=User:{{$info['appealfor']}}"><button type="button" class="btn btn-light">Block Log</button></a>&nbsp;<a href="https://meta.wikimedia.org/wiki/Special:CentralAuth?target={{$info['appealfor']}}"><button type="button" class="btn btn-light">Global (b)locks</button></a>&nbsp;
                            @if($perms['admin'])
                                <a href="https://en.wikipedia.org/wiki/Special:Unblock/{{$info['appealfor']}}"><button type="button" class="btn btn-warning">Unblock</button></a>
                            @endif
                            @if($perms['checkuser'])
            ...
            <i>Lines that are in blue indicate a response to the user. Lines in green are comments from other administrators or the user involved.</i>
            <br />
			<br />
            @if($perms['admin'])
            <div class="container">
