		...
		<h5 class="card-header">Appeal details</h5>
  		<div class="card-body">
			...
			<div class="alert alert-danger" role="alert">
  				...
  				<p>You are currently reading an appeal made in UTRS 1.8. Backwards compatability is availible for viewing only. Commenting on legacy appeals is restricted. If you feel this is in error, please file a request with the developers.</p>
			</div>
