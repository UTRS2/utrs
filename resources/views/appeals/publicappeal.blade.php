...
@section('content')
    ...
    @if($info['status']=="NOTFOUND")
        ...
        <div class="alert alert-danger" role="alert">The block for your appeal could not be found. Please <a
                    href="/fixappeal/{{$hash}}">modify the information</a>.
        </div>
    @endif
    <br/>
    <div class="card">
                ...
                <div class="row">
                    ...
                    <div class="col-5">
                        ...
                        <p class="card-text">
                            ...
                            @endif
                            @if($info['status'] == "NOTFOUND")
                                <a href="/fixappeal/{{$hash}}">
                                    <button class="btn btn-success">Fix Block information</button>
                                </a>
                            @endif
                        </p>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-3">
                            ...
                            @elseif($info['privacylevel']==1 && $info['privacyreview']==0)
                                <center>This appeal is considered private. Only logged in administrators have access to
                                    this appeal.
                                    <br/><img
                            ...
                            @elseif($info['privacylevel']==2 || $info['privacyreview']!=0)
                                <center>This appeal is not availiable for viewing by all administrators at this time.
                                    This can occur for multiple reasons and is normal.
                                    <br/><img
